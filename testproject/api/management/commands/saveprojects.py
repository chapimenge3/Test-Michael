...
from api.models import Projects, Country, Sector
    ...
    def handle(self, *args, **options):
        ...
        for i in range(10):
            ...
            for project in data:
                ...
                if project.get('primaryTags', None) and isinstance(project.get('primaryTags'), list):
                    primaryTags = project.get('primaryTags')
        ...
        self.stdout.write(self.style.SUCCESS(
            "Successfully saved {} projects".format(saved)))
